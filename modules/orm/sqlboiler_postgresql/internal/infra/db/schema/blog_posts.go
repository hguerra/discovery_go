...
var BlogPostWhere = struct {
	...
	Title:    whereHelpernull_String{field: "\"blog_posts\".\"title\""},
	Body:     whereHelpernull_String{field: "\"blog_posts\".\"body\""},
	AuthorID: whereHelpernull_Int64{field: "\"blog_posts\".\"author_id\""},
}
...
var (
	blogPostAllColumns            = []string{"id", "title", "body", "author_id"}
	blogPostColumnsWithoutDefault = []string{}
	blogPostColumnsWithDefault    = []string{"id", "title", "body", "author_id"}
...
func (q blogPostQuery) One(ctx context.Context, exec boil.ContextExecutor) (*BlogPost, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schema: failed to execute a one query for blog_posts")
	}
...
func (q blogPostQuery) All(ctx context.Context, exec boil.ContextExecutor) (BlogPostSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "schema: failed to assign all query results to BlogPost slice")
	}
...
func (q blogPostQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to count blog_posts rows")
	}
...
func (q blogPostQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "schema: failed to check if blog_posts exists")
	}
...
func (blogPostL) LoadAuthor(ctx context.Context, e boil.ContextExecutor, singular bool, maybeBlogPost interface{}, mods queries.Applicator) error {
	var slice []*BlogPost
	var object *BlogPost
...
// SetAuthorG of the blogPost to the related item.
// Sets o.R.Author to related.
// Adds o to related.R.AuthorBlogPosts.
// Uses the global database handle.
func (o *BlogPost) SetAuthorG(ctx context.Context, insert bool, related *User) error {
...
// Sets o.R.Author to related.
// Adds o to related.R.AuthorBlogPosts.
func (o *BlogPost) SetAuthor(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
...
// Uses the global database handle.
func (o *BlogPost) RemoveAuthorG(ctx context.Context, related *User) error {
...
// Sets o.R.Author to nil.
// Removes o from all passed in related items' relationships struct.
func (o *BlogPost) RemoveAuthor(ctx context.Context, exec boil.ContextExecutor, related *User) error {
	var err error
	...
	for i, ri := range related.R.AuthorBlogPosts {
		if queries.Equal(o.AuthorID, ri.AuthorID) {
			continue
		}

		ln := len(related.R.AuthorBlogPosts)
		if ln > 1 && i < ln-1 {
			related.R.AuthorBlogPosts[i] = related.R.AuthorBlogPosts[ln-1]
		}
		related.R.AuthorBlogPosts = related.R.AuthorBlogPosts[:ln-1]
		break
	}
	return nil
}
...
func FindBlogPostG(ctx context.Context, iD int64, selectCols ...string) (*BlogPost, error) {
...
func FindBlogPost(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*BlogPost, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "schema: unable to select from blog_posts")
	}
...
func (o *BlogPost) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("schema: no blog_posts provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to insert into blog_posts")
	}
...
func (o *BlogPost) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("schema: unable to update blog_posts, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update blog_posts row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by update for blog_posts")
	}
...
func (q blogPostQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update all for blog_posts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to retrieve rows affected for blog_posts")
	}
...
func (o BlogPostSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to update all in blogPost slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to retrieve rows affected all in update all blogPost")
	}
	return rowsAff, nil
}
...
func (o *BlogPost) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("schema: no blog_posts provided for upsert")
	}
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("schema: unable to upsert blog_posts, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to upsert blog_posts")
	}
...
func (o *BlogPost) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("schema: no BlogPost provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete from blog_posts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by delete for blog_posts")
	}
...
func (q blogPostQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("schema: no blogPostQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete all from blog_posts")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "schema: failed to get rows affected by deleteall for blog_posts")
	}
...
func (o BlogPostSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "schema: unable to delete all from blogPost slice")
	}
...
func (o *BlogPost) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("schema: no BlogPost provided for reload")
	}
...
func (o *BlogPostSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("schema: empty BlogPostSlice provided for reload all")
	}
...
func (o *BlogPostSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "schema: unable to reload all in BlogPostSlice")
	}
...
func BlogPostExistsG(ctx context.Context, iD int64) (bool, error) {
...
func BlogPostExists(ctx context.Context, exec boil.ContextExecutor, iD int64) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "schema: unable to check if blog_posts exists")
	}
