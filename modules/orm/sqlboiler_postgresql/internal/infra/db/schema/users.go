...
var (
	userAllColumns            = []string{"id", "name", "last_name", "age"}
	userColumnsWithoutDefault = []string{}
	userColumnsWithDefault    = []string{"id", "name", "last_name", "age"}
...
func (userL) LoadAuthorBlogPosts(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`blog_posts`),
		qm.WhereIn(`blog_posts.author_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// AddAuthorBlogPostsG adds the given related objects to the existing relationships
// of the user, optionally inserting them as new records.
// Appends related to o.R.AuthorBlogPosts.
// Sets related.R.Author appropriately.
// Uses the global database handle.
func (o *User) AddAuthorBlogPostsG(ctx context.Context, insert bool, related ...*BlogPost) error {
	return o.AddAuthorBlogPosts(ctx, boil.GetContextDB(), insert, related...)
}
...
// Appends related to o.R.AuthorBlogPosts.
// Sets related.R.Author appropriately.
func (o *User) AddAuthorBlogPosts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*BlogPost) error {
	var err error
...
// SetAuthorBlogPostsG removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Author's AuthorBlogPosts accordingly.
// Replaces o.R.AuthorBlogPosts with related.
// Sets related.R.Author's AuthorBlogPosts accordingly.
// Uses the global database handle.
func (o *User) SetAuthorBlogPostsG(ctx context.Context, insert bool, related ...*BlogPost) error {
	return o.SetAuthorBlogPosts(ctx, boil.GetContextDB(), insert, related...)
}

// SetAuthorBlogPosts removes all previously related items of the
// user replacing them completely with the passed
// in related items, optionally inserting them as new records.
// Sets o.R.Author's AuthorBlogPosts accordingly.
// Replaces o.R.AuthorBlogPosts with related.
// Sets related.R.Author's AuthorBlogPosts accordingly.
func (o *User) SetAuthorBlogPosts(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*BlogPost) error {
	query := "update \"blog_posts\" set \"author_id\" = null where \"author_id\" = $1"
	...
	if o.R != nil {
		for _, rel := range o.R.AuthorBlogPosts {
		...
		o.R.AuthorBlogPosts = nil
	}

	return o.AddAuthorBlogPosts(ctx, exec, insert, related...)
}

// RemoveAuthorBlogPostsG relationships from objects passed in.
// Removes related items from R.AuthorBlogPosts (uses pointer comparison, removal does not keep order)
// Sets related.R.Author.
// Uses the global database handle.
func (o *User) RemoveAuthorBlogPostsG(ctx context.Context, related ...*BlogPost) error {
	return o.RemoveAuthorBlogPosts(ctx, boil.GetContextDB(), related...)
}

// RemoveAuthorBlogPosts relationships from objects passed in.
// Removes related items from R.AuthorBlogPosts (uses pointer comparison, removal does not keep order)
// Sets related.R.Author.
func (o *User) RemoveAuthorBlogPosts(ctx context.Context, exec boil.ContextExecutor, related ...*BlogPost) error {
	if len(related) == 0 {
		return nil
	}
	...
	for _, rel := range related {
		for i, ri := range o.R.AuthorBlogPosts {
			if rel != ri {
				continue
			}

			ln := len(o.R.AuthorBlogPosts)
			if ln > 1 && i < ln-1 {
				o.R.AuthorBlogPosts[i] = o.R.AuthorBlogPosts[ln-1]
			}
			o.R.AuthorBlogPosts = o.R.AuthorBlogPosts[:ln-1]
			break
		}
	}
...
func (o *User) ReloadG(ctx context.Context) error {
	if o == nil {
		return errors.New("schema: no User provided for reload")
	}
...
func (o *UserSlice) ReloadAllG(ctx context.Context) error {
	if o == nil {
		return errors.New("schema: empty UserSlice provided for reload all")
	}
